...
@ToolParserManager.register_module("apertus_json")
class ApertusJsonToolParser(ToolParser):
    """
    Tool call parser for Apertus models intended for use with the
    apertus_chat_template.jinja template.

    Used when --enable-auto-tool-choice --tool-call-parser apertus_json is set.
    """
